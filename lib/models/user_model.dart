...
class User {
    User({
        ...
        required this.essentialsDesignationId,
        required this.essentialsSalary,
        required this.essentialsPayPeriod,
        required this.essentialsPayCycle,
    ...
    factory User.fromJson(Map<String, dynamic> json) => User(
        ...
        allPermissions: json["all_permissions"] == null ? [] : List<String>.from(json["all_permissions"].map((x) => x)),
    ...
    Map<String, dynamic> toJson() => {
        ...
        "is_admin": isAdmin,
        "all_permissions": List<dynamic>.from(allPermissions.map((x) => x)),
...
class CommonSettings {
    CommonSettings({
        ...
        required this.enablePurchaseOrder,
